      ...
      <el-col :xs="24" :sm="24" :md="14" :lg="13" :xl="13">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>字典详情</span>
            <el-button v-if="checkPermission(['admin','dict:add']) && this.$refs.dictDetail && this.$refs.dictDetail.query.dictName" class="filter-item" size="mini"
                       style="float: right;padding: 4px 10px" type="primary" icon="el-icon-plus" @click="$refs.dictDetail && $refs.dictDetail.crud.toAdd()">新增</el-button>
          </div>
...
<script>
  ...
  import crudDict from '../../../api/system/dict'   //字典相关api
  import dictDetail from "./dictDetail";      //字典详情组件
  import checkPermission from '../../../utils/permission'  //权限检查
