<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="580px">
        <el-form ref="form"  :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="上级菜单" prop="pid">
            <treeselect v-model="form.pid" :options="menus" :load-options="loadMenus" style="width: 450px;" placeholder="选择上级菜单" />
          </el-form-item>
        </el-form>
      ...
      <!--菜单表格数据-->
      <el-table ref="table" v-loading="crud.loading" lazy :load="getMenus" :data="crud.data" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="id"
...
<script>
  ...
  import crudMenu from '../../../api/system/menu'   //菜单相关api
  ...
  import IconSelect from '../../../components/IconSelect'   //引入图标选择组件
