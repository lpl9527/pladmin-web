<template>
  <div class="app-container">
    <div class="head-container">
      ...
      <!--增删改查按钮组-->
      <crud-operation>
        <el-button slot="left" class="filter-item" type="danger" icon="el-icon-delete" size="mini" :loading="delLoading" :disabled="crud.selections.length === 0"
                   @click="doDelete(crud.selections)">强退</el-button>
      </crud-operation>
    </div>
...
<script>
  ...
  import { del } from '../../../api/monitor/online'     //在线用户相关api
