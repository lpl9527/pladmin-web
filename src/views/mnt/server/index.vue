    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="470px">
      <el-form ref="form" :model="form" :rules="rules" size="small" label-width="55px">
        ...
        <el-form-item label="密码" prop="password">
          ...
          <el-button :loading="loading" type="success" style="align: right; margin-left: 8px;" @click="testConnectServer">测试连接</el-button>
        </el-form-item>
      </el-form>
...
<script>
  ...
  import crudServer from '../../../api/mnt/serverDeploy'    //服务器相关api
  import { testServerConnect } from '../../../api/mnt/connect'    //连接测试相关api
  import { validateIP } from '../../../utils/validate'    //IP校验
